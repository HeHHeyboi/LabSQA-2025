...
*** Settings ***
Documentation  Register without Last name
...
${BROWSER}  Chrome
${DELAY}  1 seconds
${EXPECTED_MSG}  Please enter your last name!!

&{U1}  firstname=Somsri  organization=CS KKU  email=somsri@kkumail.com  phone=081-001-1234
